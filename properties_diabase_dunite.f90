...
!Disclocation creep
 coeffA(i)=5.047659D-28                                                  !Coefficiente pre-esponenziale dislocation creep
 ndisl(i)=4.7D0                                                  !Stress exponent dislocation creep
 Ea(i)=4.85D05                                                  !Energia di attivazione dislocation creep
...
!Materiale 3
 ...
 uniaxial(i)=.true.                                         !Valore del coefficiente pre-esponenziale usato - .true. se uniassiale - .false. se convertito
!Disclocation creep
 coeffA(i)=1.13D-21                                                  !Coefficiente pre-esponenziale dislocation creep
 ndisl(i)=3.6D0                                                  !Stress exponent dislocation creep
 Ea(i)=5.35D05                                                  !Energia di attivazione dislocation creep
...
!Diffusion creep
 ...
 coeffAdf(i)=1.5D-15                                                  !Coefficiente pre-esponenziale diffusion creep
